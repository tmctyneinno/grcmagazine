...
<div class="min-h-screen bg-[#f8f6f0]" style="font-family: 'EB Garamond', serif;">
    ...
    @else
        ...
        <header class="relative w-full bg-[#0b1220] pt-3 pb-12 px-6 md:px-12 lg:px-20">
            
            {{-- Gold Top Border --}}
            <div class="absolute top-0 left-0 w-full h-[3px] bg-[#c9a227]"></div>
            ...
            <div class="max-w-5xl mx-auto mt-6">
                ...
                {{-- Main Title --}}
                <h1 class="text-3xl md:text-4xl lg:text-[2.8rem] font-bold text-white leading-tight mb-6" style="font-family: 'Playfair Display', serif;">
                    {{ $post->title }}
                </h1>

                {{-- Sub-tags / Keywords --}}
                <p class="text-gray-400 text-lg italic mb-6 tracking-wide">
                    Insight . Intelligence . Accountability
                </p>

                {{-- Meta Stats (Views & Comments) --}}
                <div class="flex items-center gap-8 text-gray-300 text-sm md:text-base">
        ...
        <main class="max-w-4xl mx-auto px-6 md:px-12 lg:px-20 py-12">
            ...
            {{-- Date & Share Bar (Optional, based on previous context) --}}

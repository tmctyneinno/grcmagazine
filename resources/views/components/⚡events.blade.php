                ...
                <div class="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 group hover:shadow-md transition-shadow duration-300">
                    ...
                    <div class="p-5 pt-2">
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="{{ url('/events/'.$event['slug']) }}" wire:navigate class="inline-flex items-center gap-1 text-xs font-bold uppercase tracking-wider text-gray-900 hover:text-[#c9a227] transition-colors">
                                Read Full Brief
